...
public class MapOverdrawFactorPreference extends DialogPreference {
    ...
    public static final float DEFAULT_VALUE = 1.2f;
    ...
    public MapOverdrawFactorPreference(Context context, AttributeSet attrs) {
        ...
        SummaryProvider<DialogPreference> summaryProvider = preference -> formatOverdrawFactor(PreferencesUtils.getOverdrawFactor());
        setSummaryProvider(summaryProvider);
    }

    @NonNull
    private static String formatOverdrawFactor(final double overdrawFactor) {
        return String.format(Locale.getDefault(), "%.2f", overdrawFactor);
    }
    ...
    public static class MapOverdrawFactorPreferenceDialog extends PreferenceDialogFragmentCompat {
        ...
        protected void onBindDialogView(@NonNull View view) {
            ...
            tvOverdrawFactor.setText(formatOverdrawFactor(currentOverdrawFactor));
            ...
            sbOverdrawFactor.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                    tvOverdrawFactor.setText(formatOverdrawFactor(getOverdrawFactorFromProgress()));
                }
